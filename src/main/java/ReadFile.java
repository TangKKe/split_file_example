...
public class ReadFile extends Observable {
     ...
     * @throws Exception
     */
    public void readFileByLine(String fullPath, long start, long end, String name) throws Exception {
            ...
            try {
                ...
                while (fcin.read(rBuffer) != -1) {
                    ...
                    while ((endIndex = indexOf(newStrByte, fromIndex)) != -1) {
                        ...
                        lineNum++;
                        // 输出一行内容，处理方式由调用方提供
                        readerListener.outLine(line.trim(), lineNum, false,name);
                ...
                readerListener.outLine(lineStr.trim(), lineNum, true,name);
